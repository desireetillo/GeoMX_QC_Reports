...
This report outlines the initial QC for **`r projectname`** using the module **`r PKCfilename`**.  
...
Q3 normalization is typically the preferred normalization strategy for most DSP-NGS RNA studie, so we will perform Q3 normalization here.
