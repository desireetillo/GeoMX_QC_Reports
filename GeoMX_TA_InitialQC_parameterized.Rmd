...
This report outlines the initial QC for `r params$projectname`.  For more information about this workflow, please see the [GeoMXWorkflows vignette](https://bioconductor.org/packages/release/workflows/vignettes/GeoMxWorkflows/inst/doc/GeomxTools_RNA-NGS_Analysis.html) on Bioconductor.
